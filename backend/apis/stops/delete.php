...
if($row){
    ...
    // tell the user
    echo json_encode(array("message" => "Stop was deleted."));
}
  
// if unable to delete the stops
    else{
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to delete stop."));
    }
}
else{
